...
void Get_input(int* inserts_in_main_p) {
   ...
   printf("Cuantas llaves deben ser insertados en el hilo principal?\n");
   scanf("%d", inserts_in_main_p);
   printf("Cuantas operaciones deberian ser ejecutadas?\n");
   scanf("%d", &total_ops);
   printf("Porcentaje de operaciones que se deberia de buscar? (entre 0-1)\n");
   scanf("%lf", &search_percent);
   printf("Porcentaje de operaciones que se deberian de insertar? (entre 0-1)\n");
